...
t=sunspot[:,0] #time corresponding to each month number of sunspots were recorded since January 1749
s=sunspot[:,1] #number of sunspots recorded each month after Jan 1749.
...
plt.plot(t,s)#Plot the number of sunspots as a function of time
...
plt.savefig('ex3.1a.jpg',format='jpg',dpi=1000)#save the resulting figure as an image.
